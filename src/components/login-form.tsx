...
import BitBucketImage from "../assets/bitbucket.png";
    ...
    >
      <div className="flex flex-col items-center gap-2 text-center bg-white min-w-[max-content]">
        ...
        <div className="grid gap-6 pt-3 pb-4">
          ...
          {selectedMode === "saas" && (
            <Button variant="outline" className="w-full">
              <img src={BitBucketImage} alt="BitBucket" className="h-6 w-6 mr-2" />
              Sign in with Bitbucket
            </Button>
          )}
          {selectedMode === "saas" && (
            <Button variant="outline" className="w-full">
              <img src={AzureImage} alt="Azure" className="h-6 w-6 mr-2" />
              Sign in with Azure DevOps
            </Button>
          )}
          
          <Button variant="outline" className="w-full">
            <img src={GitLabImage} alt="GitLab" className="h-6 w-6 mr-2" />
            Sign in with GitLab
          </Button>
          {selectedMode === "self-hosted" && (
            <Button variant="outline" className="w-full">
              <img src={KeyImage} alt="Key" className="h-6 w-6 mr-2" />
              Sign in with SSO
            </Button>
          )}
        </div>
